...
\begin{itemize}[nosep, after=\strut, leftmargin=1.5em, itemsep=2pt]
    \item Designed \textbf{LOGICAL-COMMONSENSEQA}, a benchmark for logical commonsense reasoning, with structurally composed questions and answer options to isolate multi-fact and compositional inference in LLMs.
    ...
    \item Conducting empirical analyses on how reasoning performance varies with task structure and inference depth, forming the basis of an ongoing research manuscript.
\end{itemize}
...
\begin{itemize}[nosep, after=\strut, leftmargin=1.5em, itemsep=2pt]
    ...
    \item Led the research design and analysis for a first-author, peer-reviewed publication presented at BHI 2025.
\end{itemize}

\begin{tabularx}{\linewidth}{@{}X r@{}}
\textbf{Efficient Multi-Agent LLM Inference with Parameter-Efficient Adaptation} & Aug 2025 – Dec 2025 \\
\multicolumn{2}{@{}X@{}}{\textit{University of Colorado Boulder}} \\
\end{tabularx}
\begin{itemize}[nosep, after=\strut, leftmargin=1.5em, itemsep=2pt]
...
\end{tabularx}
\begin{itemize}[nosep, after=\strut, leftmargin=1.5em, itemsep=2pt]
    \item Formulated a semantic retrieval task for “tip-of-the-tongue” queries, targeting underspecified and ambiguous natural-language descriptions requiring semantic rather than lexical matching.
    \item Designed a BERT-based dual-encoder trained with a multi-task contrastive learning objective to align free-form user descriptions with structured movie metadata.
